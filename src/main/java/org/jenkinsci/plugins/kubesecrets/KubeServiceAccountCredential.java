 ...
 */
public class KubeServiceAccountCredential extends org.csanchez.jenkins.plugins.kubernetes.ServiceAccountCredential {

    private static final String SERVICEACCOUNT_TOKEN_PATH = "/Users/hosh/Workspace/tesco/aurora-core/kubernetes-secrets/src/main/resources/token";

    @DataBoundConstructor
    public KubeServiceAccountCredential(CredentialsScope scope, String id, String description) {
